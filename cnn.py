...
class Graph:
    def __init__(self, head_size, body_size, image_size, l2_reg_lambda=3.0,
                 ...
                 lr=5e-4, num_filters=256,a1=0.6,b1=0.0):
        ...
        print(self.input_headline.shape)
        ...
        with tf.compat.v1.name_scope('loss'):
            ...
            beta = tf.constant(0, dtype=tf.float64, name='beta')
            ...
            fake_acc_summary = tf.compat.v1.summary.scalar("acc", self.accuracy)
